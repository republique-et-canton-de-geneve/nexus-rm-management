...
| Display of the unused privileges | Dumps the list of the privileges that belong to no role. The output is dumped in the log file and on the standard output. | 8 | 8 |
